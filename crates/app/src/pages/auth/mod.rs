        ...
        <div class="min-h-screen flex items-center justify-center bg-surface-page px-4">
            <div class="w-full max-w-md space-y-8">
                ...
                <div class="bg-surface-card rounded-3xl shadow-lg p-8 space-y-6">
                    ...
                    // OAuth buttons (disabled — not yet available)
                    <div class="space-y-3">
                        <button
                            class="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 opacity-50 cursor-not-allowed transition-colors"
                            disabled=true
                        >
                            ...
                            {t("auth.signin.google")}" (준비 중)"
                        </button>

                        <button
                            class="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#03C75A] text-white rounded-xl text-sm font-medium opacity-50 cursor-not-allowed transition-colors"
                            disabled=true
                        >
                            <span class="font-bold text-lg">"N"</span>
                            {t("auth.signin.naver")}" (준비 중)"
                        </button>

                        <button
                            class="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#FEE500] text-[#191919] rounded-xl text-sm font-medium opacity-50 cursor-not-allowed transition-colors"
                            disabled=true
                        >
